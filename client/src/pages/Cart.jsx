  ...
  const PlaceOrder = async () => {
    ...
    try {
      ...
      if (!isDeliveryDetailsFilled || !isPaymentDetailsFilled) {
        // Show an error message or handle the situation where details are incomplete
        dispatch(
          openSnackbar({
      ...
      setReload(!reload);
      // pass the created order to Orders page so it appears immediately
                    ...
                    <div>
                      ...
                      >
                        <TextInput
                          small
                          placeholder="DD"
                          value={paymentDetails.expiryDay}
                          handelChange={(e) =>
                            setPaymentDetails({
                              ...paymentDetails,
